...
export default function Reg() {
  const dispatch = useDispatch(),
    setLoginAction = (e: any) => dispatch(setLogin(e.target.value)),
    setPasswordAction = (e: any) => dispatch(setPassword(e.target.value))
  ...
  return (
    <div className="authPopUp-content">
      ...
      <button className="submit" onClick={() => dispatch(signUp())}>
        Enter
      </button>
    </div>
  )
